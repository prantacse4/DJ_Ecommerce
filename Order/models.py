...
class ShopCartDevice(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, null=True)
...
class Order(models.Model):
    ...
    def image_tag(self):
        if self.image:
            return mark_safe('<img src="{}" height="70" width="60" />'.format(self.transaction_image.url))
...
class ShippingCharge(models.Model):
    ...
    charge = models.IntegerField(default = 100, blank=True, null=True)